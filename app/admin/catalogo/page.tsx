...
export default async function AdminCatalogoPage() {
  ...
  const [items, productos, sucursales] = await Promise.all([
    ...
    prisma.producto.findMany({
      select: { id: true, nombre: true, imagenUrl: true, activo: true },
      orderBy: { nombre: "asc" },
    }),
